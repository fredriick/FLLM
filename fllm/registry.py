...
REGISTRY: Dict[str, FamilyEntry] = {
    ...
    "gemma3": FamilyEntry(
        ...
        default_system="",
        sizes=[
            SizeEntry("1",  1.0,  n_layers=18),
            SizeEntry("4",  4.0,  n_layers=34),
            SizeEntry("12", 12.0, n_layers=46),
            SizeEntry("27", 27.0, n_layers=62),
        ],
        gguf_repo_template="bartowski/google_gemma-3-{size}b-it-GGUF",
        gguf_file_template="google_gemma-3-{size}b-it-{quant}.gguf",
        hf_repo_template="google/gemma-3-{size}b-it",
        mlx_repo_template="mlx-community/gemma-3-{size}b-it-4bit",
        draft_gguf_repo="bartowski/google_gemma-3-1b-it-GGUF",
        draft_gguf_file="google_gemma-3-1b-it-Q4_K_M.gguf",
    ),
